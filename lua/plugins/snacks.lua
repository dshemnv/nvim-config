return {
 ...
 █                                                                           
  ...
  keys = {
    ...
    { "<leader>/", function() Snacks.picker.grep({cwd = vim.fn.expand("%:h")}) end, desc = "Grep (Root dir)" },
    { "<leader>n", function() Snacks.picker.notifications() end, desc = "Notification History" },
    { "<leader>e", function() Snacks.explorer({cwd = vim.fn.expand("%:h")}) end, desc = "File Explorer" },
    -- find
    { "<leader>sb", function() Snacks.picker.buffers() end, desc = "Buffers" },
    { "<leader>sc", function() Snacks.picker.files({ cwd = vim.fn.stdpath("config") }) end, desc = "[S]earch [C]onfig File" },
